...
from app.controllers.admin.dashboard_controlller import DashboardController
...
async def login_page(request: Request):
    data = authController.get_authentication_data("login")  
...
async def admin_dashboard(request: Request):
    data = dashboardController.get_dashboard_data("dashboard22222")
    return templates.TemplateResponse(
        "admin_pages/dashboard.html",
        {
            "request": request,
            "page_title": "Dashboard3321",
            "app_name": "Document QRSS Manager",
